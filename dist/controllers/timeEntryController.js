...
exports.deleteTimeEntry = exports.updateTimeEntry = exports.createTimeEntry = exports.getTimeEntriesByDateRange = exports.getTimeEntriesByLeader = exports.getTimeEntriesByProject = exports.getTimeEntriesByUser = exports.getAllTimeEntries = void 0;
...
const getTimeEntriesByUser = (req, res) => {
    try {
...
exports.getTimeEntriesByUser = getTimeEntriesByUser;
...
exports.getTimeEntriesByProject = getTimeEntriesByProject;
const getTimeEntriesByLeader = (req, res) => {
    try {
...
exports.getTimeEntriesByLeader = getTimeEntriesByLeader;
const getTimeEntriesByDateRange = (req, res) => {
    try {
...
exports.getTimeEntriesByDateRange = getTimeEntriesByDateRange;
...
const deleteTimeEntry = (req, res) => {
    try {
        const { id } = req.params;
        const result = database_1.default.prepare('DELETE FROM time_entries WHERE id = ?').run(id);
        if (result.changes === 0) {
            return res.status(404).json({ success: false, message: 'Registro no encontrado' });
        }
